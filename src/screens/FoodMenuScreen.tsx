...
const categoryMap: Record<string, string> = {
  leves: 'Levesek',
  szarnyas: 'Szárnyas ételek',
  sertes: 'Sertés ételek',
  marha: 'Marha ételek',
  hal: 'Halételek',
  vega: 'Vega ételek',
  gyerek: 'Gyerekmenü',
  glutenmentes: 'Gluténmentes ételek',
  koret: 'Köretek',
  desszert: 'Desszertek',
  mentes: 'Alkoholmentes italok',
  alkoholos: 'Alkoholos italok',
};



type Props = StackScreenProps<RootStackParamList, 'FoodMenu'>;

const FoodMenuScreen: React.FC<Props> = ({navigation}) => {
...
useEffect(() => {
  const fetchMenu = async () => {
    try {
      ...
      console.error('Hiba az étlap betöltésekor:', error);
    }
    finally {
      setLoading(false); 
    }
    ...
    <View style={styles.container}>
      <View style={styles.topBar}>
        ...
        <View style={styles.header}>
          <Text style={styles.headerText}>Étlap</Text>
        </View>
        <TouchableOpacity 
          style={styles.iconButton}
      ...
      <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>A szállás díja tartalmazza az étkezések árát a vendégek számára.</Text>
        </View>
      ...
      <View style={styles.dropdownWrapper}>
        ...
        >
          <Text style={styles.dropdownToggleText}>
            {selectedCategory ? categoryMap[selectedCategory] : 'Összes kategória'}
          </Text>
          <FontAwesomeIcon icon={dropdownVisible ? faCaretUp : faCaretDown} size={16} />
        </TouchableOpacity>
